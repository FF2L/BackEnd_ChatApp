  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <a href="http://47.129.240.146:5000/api/auth/verify?token=${encodeURIComponent(token)}">Xác thực tài khoản</a>
      `,
    };
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <a href="http://47.129.240.146:5000/api/auth/verify-reset-password?token=${token}&room=${roomId}">Đặt lại mật khẩu</a>
      `,
    };
